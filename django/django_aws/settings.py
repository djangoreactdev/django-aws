...
DATABASES = {"default": env.db(default="postgresql://postgres:postgres@127.0.0.1:5432/django_aws")}
...
CELERY_BROKER_TRANSPORT_OPTIONS = {"region": env("AWS_REGION", default="eu-west-1")}
